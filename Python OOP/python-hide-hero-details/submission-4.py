class SuperHero:
    ...
    def set_health(self, new_health: int) -> int:
        if new_health > 100:
    ...
    def set_power_level(self, new_power_level: int) -> int:
        if new_power_level > 10:
            print(f"You can't set the power level to more than 10")
        elif new_power_level < 1:
            print(f"You can't set the power level to less than 0")
        else:
...
print(f"{super_hero.name} has {super_hero.set_health} health and {super_hero.set_power_level} power level")
